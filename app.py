...
class AnalyticsEngine:
    ...
    def monte_carlo_forecast(series, n_sims=200, horizon=252):
        ...
        # On utilise les 2 dernières années pour capturer la volatilité récente
...
def get_data(tickers, start, end):
    ...
    if len(clean) == 1:
        ...
        for t in clean:
            try:
                # Structure yfinance MultiIndex complexe
...
with col_main:
    ...
    if data.empty or len(data) < 10:
        st.error("❌ NO DATA. Check tickers or date range.")
    else:
        ...
        with t1:
            ...
            for t in trades:
                ...
                fig.add_annotation(x=t['date'], y=df_res.loc[t['date']]['portfolio'], text=symbol, 
            ...
            fig.update_layout(
                ...
                xaxis2=dict(showgrid=False, linecolor='#333'), yaxis=dict(gridcolor='rgba(255,255,255,0.05)'),
